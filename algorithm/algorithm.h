 ...
 * live above their DEFINITIONS in algorithm.c (file-level convention).
 *
 * Header-only-style declarations for an STL <algorithm>-flavoured
 * surface — sort/merge/copy/find/transform/reduce/permutation/etc.
 * Every function works on opaque element-sized memory blocks.
 */
...
#else
    #define ALGORITHM_LOG(...) do { } while (0)
#endif
...
typedef void     (*IncrementFunc)              (void* current);
...
/* ------------------------------------------------------------------ */
/* Built-in incrementers for algorithm_iota                           */
/* ------------------------------------------------------------------ */

/* Ready-made incrementers for built-in numeric types — pass these as
 * the `increment` argument to algorithm_iota for the common case.
 * Each does exactly `*(T*)current += 1` on a value of the
 * corresponding type. */
void  algorithm_inc_int                       (void* current);
void  algorithm_inc_char                      (void* current);
void  algorithm_inc_short                     (void* current);
void  algorithm_inc_long                      (void* current);
void  algorithm_inc_long_long                 (void* current);
void  algorithm_inc_uchar                     (void* current);
void  algorithm_inc_ushort                    (void* current);
void  algorithm_inc_uint                      (void* current);
void  algorithm_inc_ulong                     (void* current);
void  algorithm_inc_ulong_long                (void* current);
void  algorithm_inc_float                     (void* current);
void  algorithm_inc_double                    (void* current);
void  algorithm_inc_long_double               (void* current);
void  algorithm_inc_int8                      (void* current);
void  algorithm_inc_int16                     (void* current);
void  algorithm_inc_int32                     (void* current);
void  algorithm_inc_int64                     (void* current);
void  algorithm_inc_uint8                     (void* current);
void  algorithm_inc_uint16                    (void* current);
void  algorithm_inc_uint32                    (void* current);
void  algorithm_inc_uint64                    (void* current);
void  algorithm_inc_size_t                    (void* current);
...
void  algorithm_merge                         (const void* base1, size_t num1, const void* base2, size_t num2,
                                               size_t size, void* result, CompareFunc comp);
...
void  algorithm_rotate_copy                   (const void* first, const void* middle, const void* last,
...
const void* algorithm_search                  (const void* first1, const void* last1, size_t size1, const void* first2, const void* last2, size_t size2,
