...
#define CONFIGURE_ARGS " '--build=x86_64-w64-mingw32' '--host=x86_64-w64-mingw32' '--target=x86_64-w64-mingw32' '--prefix=/mingw64' '--enable-thread-safety' '--enable-integer-datetimes' '--enable-nls' '--disable-rpath' '--with-ldap' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-ssl=openssl' '--with-python' '--with-zstd' '--without-perl' '--with-tcl' '--with-tclconfig=/mingw64/lib' 'build_alias=x86_64-w64-mingw32' 'host_alias=x86_64-w64-mingw32' 'target_alias=x86_64-w64-mingw32' 'CC=gcc' 'CFLAGS=-march=nocona -msahf -mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong' 'LDFLAGS=-pipe' 'CPPFLAGS=-D__USE_MINGW_ANSI_STDIO=1' 'CXX=g++' 'CXXFLAGS=-march=nocona -msahf -mtune=generic -O2 -pipe -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong' 'PKG_CONFIG_PATH=/mingw64/lib/pkgconfig:/mingw64/share/pkgconfig' 'PYTHON=/mingw64/bin/python'"
...
#define PG_VERSION_STR "PostgreSQL 16.2 on x86_64-w64-mingw32, compiled by gcc.exe (Rev5, Built by MSYS2 project) 13.2.0, 64-bit"
